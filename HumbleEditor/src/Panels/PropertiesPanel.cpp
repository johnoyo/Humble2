...
namespace HBL2::Editor
{
	...
	{
		const ImGuiTreeNodeFlags treeNodeFlags = ImGuiTreeNodeFlags_DefaultOpen | ImGuiTreeNodeFlags_SpanAvailWidth | ImGuiTreeNodeFlags_Framed
	...
	PropertiesPanel::PropertiesPanel(const std::string& name, EditorPanelSystem* owner)
	{
		m_Owner = owner;
		Name = name;
	}
	...
	void PropertiesPanel::OnOpen()
	{
	}

	void PropertiesPanel::OnRender(float ts)
	{
		...
		{
			// Tag component.
			if (activeScene->HasComponent<HBL2::Component::Tag>(HBL2::Component::EditorVisible::SelectedEntity))
			{
			...
			// Transform component.
			if (activeScene->HasComponent<HBL2::Component::Transform>(HBL2::Component::EditorVisible::SelectedEntity))
			{
			...
			DrawComponent<HBL2::Component::Link>("Link", activeScene, [this, activeScene](HBL2::Component::Link& link)
			{
				...
				if (renderBaseEditor)
				{
					...
					if (ImGui::BeginDragDropTarget())
					{
						if (const ImGuiPayload* payload = ImGui::AcceptDragDropPayload("Entity_UUID"))
						{
							...
							UUID childEntityUUID = activeScene->GetComponent<HBL2::Component::ID>(HBL2::Component::EditorVisible::SelectedEntity).Identifier;
			...
			DrawComponent<HBL2::Component::Camera>("Camera", activeScene, [this](HBL2::Component::Camera& camera)
			{
				bool renderBaseEditor = true;
			...
			DrawComponent<HBL2::Component::Light>("Light", activeScene, [this](HBL2::Component::Light& light)
			{
			...
			DrawComponent<HBL2::Component::SkyLight>("SkyLight", activeScene, [this](HBL2::Component::SkyLight& skyLight)
			{
			...
			DrawComponent<HBL2::Component::AudioSource>("AudioSource", activeScene, [this](HBL2::Component::AudioSource& audioSource)
			{
			...
			DrawComponent<HBL2::Component::AudioListener>("AudioListener", activeScene, [this](HBL2::Component::AudioListener& audioListener)
			{
				ImGui::Checkbox("Enabled", &audioListener.Enabled);
			});

			DrawComponent<HBL2::Component::Rigidbody2D>("Rigidbody2D", activeScene, [this](HBL2::Component::Rigidbody2D& rb2d)
			{
			...
			DrawComponent<HBL2::Component::BoxCollider2D>("BoxCollider2D", activeScene, [this](HBL2::Component::BoxCollider2D& bc2d)
			{
			...
			DrawComponent<HBL2::Component::Rigidbody>("Rigidbody", activeScene, [this](HBL2::Component::Rigidbody& rb)
			{
			...
			DrawComponent<HBL2::Component::BoxCollider>("BoxCollider", activeScene, [this](HBL2::Component::BoxCollider& bc)
			{
				ImGui::Checkbox("Enabled", &bc.Enabled);
				ImGui::DragFloat3("Size", glm::value_ptr(bc.Size));
			});

			DrawComponent<HBL2::Component::SphereCollider>("SphereCollider", activeScene, [this](HBL2::Component::SphereCollider& sc)
			{
				ImGui::Checkbox("Enabled", &sc.Enabled);
				ImGui::DragFloat("Radius", &sc.Radius);
			});

			DrawComponent<HBL2::Component::CapsuleCollider>("CapsuleCollider", activeScene, [this](HBL2::Component::CapsuleCollider& cc)
			{
			...
			DrawComponent<HBL2::Component::TerrainCollider>("TerrainCollider", activeScene, [this](HBL2::Component::TerrainCollider& tc)
			{
				ImGui::Checkbox("Enabled", &tc.Enabled);
				ImGui::DragInt2("ViewedCoord", glm::value_ptr(tc.ViewedCoord));
			});

			DrawComponent<HBL2::Component::Terrain>("Terrain", activeScene, [this](HBL2::Component::Terrain& t)
			{
				// Normalisation mode.
				{
			...
			DrawComponent<HBL2::Component::TerrainChunk>("TerrainChunk", activeScene, [this](HBL2::Component::TerrainChunk& tc)
			{
			...
			DrawComponent<HBL2::Component::PrefabInstance>("PrefabInstance", activeScene, [this](HBL2::Component::PrefabInstance& pi)
			{
			...
			{
				if (entry.hasInRegistry(&activeScene->GetRegistry(), HBL2::Component::EditorVisible::SelectedEntity))
				{
					...
					if (opened)
					{
						Reflect::Any componentMeta = entry.getFromRegistry(&activeScene->GetRegistry(), HBL2::Component::EditorVisible::SelectedEntity);
					...
					if (removeComponent)
					{
						entry.removeFromRegistry(&activeScene->GetRegistry(), HBL2::Component::EditorVisible::SelectedEntity);
					}
				}
			});
			...
			{
				AddComponentButton<HBL2::Component::Sprite>("Sprite", activeScene);
				AddComponentButton<HBL2::Component::StaticMesh>("StaticMesh", activeScene);
				AddComponentButton<HBL2::Component::Camera>("Camera", activeScene);
				AddComponentButton<HBL2::Component::Link>("Link", activeScene);
				AddComponentButton<HBL2::Component::Light>("Light", activeScene);
				AddComponentButton<HBL2::Component::SkyLight>("SkyLight", activeScene);
				AddComponentButton<HBL2::Component::AudioSource>("AudioSource", activeScene);
				AddComponentButton<HBL2::Component::Rigidbody2D>("Rigidbody2D", activeScene);
				AddComponentButton<HBL2::Component::BoxCollider2D>("BoxCollider2D", activeScene);
				AddComponentButton<HBL2::Component::Rigidbody>("Rigidbody", activeScene);
				AddComponentButton<HBL2::Component::BoxCollider>("BoxCollider", activeScene);
				AddComponentButton<HBL2::Component::SphereCollider>("SphereCollider", activeScene);
				AddComponentButton<HBL2::Component::CapsuleCollider>("CapsuleCollider", activeScene);
				AddComponentButton<HBL2::Component::Terrain>("Terrain", activeScene);
				AddComponentButton<HBL2::Component::AnimationCurve>("AnimationCurve", activeScene);
				...
				Reflect::ForEachRegisteredType([&](const Reflect::TypeEntry& entry)
				{
					if (!entry.hasInRegistry(&activeScene->GetRegistry(), HBL2::Component::EditorVisible::SelectedEntity))
					{
						...
						{
							entry.addToRegistry(&activeScene->GetRegistry(), HBL2::Component::EditorVisible::SelectedEntity);
							ImGui::CloseCurrentPopup();
						}
					}
				});
			...
			if (m_Owner->m_SelectedAsset.IsValid())
			{
				...
				case AssetType::Shader:
				{
					...
					if (!JobSystem::Get().Busy(m_MaterialShaderReflectionCtx))
					{
						...
						{
							AssetManager::Instance->ReloadAsset<Shader>(m_Owner->m_SelectedAsset);
				...
				case AssetType::Material:
				{
					...
					if (!JobSystem::Get().Busy(m_MaterialShaderReflectionCtx) && m_MaterialShaderReflectionStarted)
					{
						...
						{
							AssetManager::Instance->ReloadAsset<Material>(m_Owner->m_SelectedAsset);
