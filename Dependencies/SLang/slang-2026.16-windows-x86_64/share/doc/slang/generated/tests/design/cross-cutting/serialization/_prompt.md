# Prompt: docs/generated/tests/design/cross-cutting/serialization/
...
Produce the test bundle at `docs/generated/tests/design/cross-cutting/serialization/`,
anchored to
...
```
//TEST:COMPILE: docs/generated/tests/design/cross-cutting/serialization/<src>.slang -o docs/generated/tests/design/cross-cutting/serialization/<out>.slang-module
//TEST:SIMPLE(filecheck=CHECK): -dump-module docs/generated/tests/design/cross-cutting/serialization/<out>.slang-module
```
...
- **`//TEST:COMPILE:` writes its output file relative to the
  ...
  the path as `docs/generated/tests/design/cross-cutting/serialization/foo.slang-module`,
