...
| C4: `[numthreads(x,y,z)]` attribute on a compute entry point is preserved in emitted HLSL, SPIR-V, GLSL, Metal, WGSL, CUDA, and CPP.                                              | functional | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | [`numthreads-attribute-emission.slang`](numthreads-attribute-emission.slang)               |
...
| C6: `WaveGetLaneCount()` compiles in a compute entry point; emits the wave-size built-in on HLSL, SPIR-V, GLSL, Metal, WGSL, and CUDA.                                            | functional | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | [`wave-lane-count-emission.slang`](wave-lane-count-emission.slang)                         |
| C10: `groupshared` attribute is emitted with the shared-memory storage qualifier on HLSL, SPIR-V, GLSL, Metal, WGSL, and CUDA.                                                    | functional | [#thread-group-execution-model](../../../../language-reference/basics-program-execution.md#thread-group-execution-model) | [`groupshared-memory-functional.slang`](groupshared-memory-functional.slang)               |
| C11: `GroupMemoryBarrier()` and `GroupMemoryBarrierWithGroupSync()` compile in a compute entry point; emit the target barrier intrinsic on HLSL, SPIR-V, GLSL, Metal, WGSL, CUDA. | functional | [#thread-group-execution-model](../../../../language-reference/basics-program-execution.md#thread-group-execution-model) | [`group-memory-barrier-emission.slang`](group-memory-barrier-emission.slang)               |
| C14: `WaveActiveBallot` (ballot wave-tangled function) compiles in a compute entry point; emits the ballot intrinsic on HLSL, SPIR-V, GLSL, Metal, WGSL, and CUDA.                | functional | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | [`wave-tangled-ballot-emission.slang`](wave-tangled-ballot-emission.slang)                 |
| C14: `WaveActiveSum` (reduction wave-tangled function) compiles in a compute entry point; emits the reduction intrinsic on HLSL, SPIR-V, GLSL, Metal, WGSL, and CUDA.             | functional | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | [`wave-tangled-reduction-emission.slang`](wave-tangled-reduction-emission.slang)           |
| C16: The `discard` statement disables a fragment thread; emits the fragment-discard instruction on HLSL, SPIR-V, GLSL, Metal, and WGSL.                                           | functional | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | [`discard-inactive-thread-emission.slang`](discard-inactive-thread-emission.slang)         |

## Untested claims

| Claim                                                                                                                                       | Reason                | Anchor                                                                                                                   | Why untested                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C1: Workload is dispatched (compute) or launched (graphics).                                                                                | implementation-detail | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | Pure model introduction; no Slang keyword or intrinsic to observe.                                                                                                                        |
| C2: The workload is divided into entry point invocations executed by threads.                                                               | implementation-detail | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | Conceptual description; the compute system-value tests (C3, C4, C5) cover the observable surface.                                                                                         |
| C6 on cpp target: `WaveGetLaneCount()` is unsupported on the cpp target.                                                                    | (unclassified)        | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | The cpp target rejects wave intrinsics at compile time (E36107); wave ops have no CPU threading equivalent in the Slang cpp prelude.                                                      |
| C7: In compute dispatches, a wave is subdivided from a thread group in a target-defined manner; applications should not assume wave shapes. | implementation-detail | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | Advisory sentence about scheduling; no observable compiler surface.                                                                                                                       |
| C8: Some waves may be partially filled when the thread group does not align with wave size.                                                 | implementation-detail | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | Target-scheduling detail; not observable via slang-test.                                                                                                                                  |
| C9: Thread group size should generally be a multiple of wave size for best utilization.                                                     | implementation-detail | [#program-execution](../../../../language-reference/basics-program-execution.md#program-execution)                       | Performance advisory; no testable compiler behavior.                                                                                                                                      |
| C10 on cpp target: `groupshared` / `GroupMemoryBarrierWithGroupSync` is unsupported on the cpp target.                                      | (unclassified)        | [#thread-group-execution-model](../../../../language-reference/basics-program-execution.md#thread-group-execution-model) | The cpp target rejects `GroupMemoryBarrierWithGroupSync` at compile time (E36107); the cpp prelude has no threadgroup-barrier primitive.                                                  |
| C11 on cpp target: `GroupMemoryBarrier()` and `GroupMemoryBarrierWithGroupSync()` are unsupported on the cpp target.                        | (unclassified)        | [#thread-group-execution-model](../../../../language-reference/basics-program-execution.md#thread-group-execution-model) | The cpp target rejects both barrier intrinsics at compile time (E36107); the cpp prelude has no group-barrier primitive.                                                                  |
| C12: The thread group execution model applies only to compute kernels.                                                                      | implementation-detail | [#thread-group-execution-model](../../../../language-reference/basics-program-execution.md#thread-group-execution-model) | Slang does not gate `groupshared` syntax at compile time for other stages; this is an execution-model semantic statement, not a compile-time restriction.                                 |
| C13: All threads in a wave execute in the SIMT model.                                                                                       | implementation-detail | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | Remark 1 notes SIMT may not apply to CPU targets; this is a model description, not an observable claim.                                                                                   |
| C14 on cpp target: `WaveActiveBallot` and `WaveActiveSum` are unsupported on the cpp target.                                                | (unclassified)        | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | The cpp target rejects wave intrinsics at compile time (E36107); warp-level ballot and reduction have no CPU equivalent in the Slang cpp prelude.                                         |
| C15: Active thread participates in producing a result.                                                                                      | implementation-detail | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | Model definition; no intrinsic exposes active-thread status directly.                                                                                                                     |
| C16 on cuda/cpp targets: `discard` in a fragment shader crashes slangc (exit 139) on the cuda and cpp targets.                              | (unclassified)        | [#wave-execution-model](../../../../language-reference/basics-program-execution.md#wave-execution-model)                 | Fragment stage with `discard` triggers an internal compiler error (signal 11) on both the cuda and cpp targets; `discard` is meaningful only in rasterization pipelines, not compute/CPU. |
